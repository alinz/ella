regenrate:
	...
	go run cmd/ella/main.go gen rpc ./e2e/rpc/rpc.gen.go ./e2e/rpc/rpc.ella
	go run cmd/ella/main.go gen http ./e2e/http_async_stream/http_async_stream.gen.go ./e2e/http_async_stream/http_async_stream.ella
